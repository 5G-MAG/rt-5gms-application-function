...
extern ogs_sbi_response_t *nf_server_new_response(char *location, char *content_type, time_t last_modified, char *etag, int cache_control, const nf_server_interface_metadata_t *interface, const nf_server_app_metadata_t *app);
