...
void af_state_initial(ogs_fsm_t *s, msaf_event_t *e)
{
    msaf_sm_debug(e);

    ogs_assert(s);

    OGS_FSM_TRAN(s, &af_state_functional);
}
...
void af_state_functional(ogs_fsm_t *s, af_event_t *e)
{
    int rv;
    ...
    switch (e->h.id) {
        case OGS_FSM_ENTRY_SIG:
            ogs_info("[%s] AF Running", ogs_sbi_self()->nf_instance->id);
